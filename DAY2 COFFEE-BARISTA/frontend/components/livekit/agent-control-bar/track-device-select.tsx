...
export function TrackDeviceSelect({
  ...
  // Always show the selector, even with one device
  ...
  return (
    ...
    >
      <SelectTrigger className={cn(selectVariants({ size }), 'bg-amber-100 border-amber-300 text-amber-800 hover:bg-amber-200', props.className)}>
        {size !== 'sm' && (
