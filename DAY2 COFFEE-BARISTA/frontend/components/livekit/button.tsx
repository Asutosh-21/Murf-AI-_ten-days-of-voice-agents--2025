    ...
    variants: {
      variant: {
        ...
        destructive: [
          ...
          'hover:bg-red-700 focus:bg-red-700 focus-visible:ring-red-600/20',
          'dark:focus-visible:ring-red-600/40',
        ],
        outline: [
        ...
        primary: 'bg-amber-600 text-white hover:bg-amber-700 focus:bg-amber-700 border-amber-600',
