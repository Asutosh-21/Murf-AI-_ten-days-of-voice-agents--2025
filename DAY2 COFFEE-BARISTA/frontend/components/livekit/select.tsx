  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          [
            'bg-white text-gray-800 relative z-50 overflow-x-hidden overflow-y-auto rounded-md border-2 border-amber-300 drop-shadow-xl shadow-lg',
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        [
          ...
          'focus:bg-amber-100 focus:text-amber-800 hover:bg-amber-50',
