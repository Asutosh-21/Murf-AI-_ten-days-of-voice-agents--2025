...
export function ChatInput({
  ...
  return (
    <motion.div
      ...
      className="border-amber-200 flex w-full items-start overflow-hidden border-b-2"
    >
      <form
      ...
      >
        <input
          ...
          className="h-8 flex-1 bg-transparent text-gray-800 placeholder-amber-600 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
        />
        <Button
          size="icon"
          type="submit"
